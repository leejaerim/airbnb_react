import { Text, Box, Grid, Heading, Skeleton, Image, GridItem, VStack, HStack, Avatar, Container } from "@chakra-ui/react";
import { useQuery } from "@tanstack/react-query";
import { FaStar } from "react-icons/fa";
import { useParams } from "react-router-dom";
import { getRoom, getRoomReView } from "../api";
...
export default function RoomDetail() {
    ...
    const { data: reviewsData, isLoading: isReviewsReview } = useQuery<IReview[]>([`rooms`, roomPk, `reviews`], getRoomReView)
    console.log(data)
    ...
    return (
        <Box mt={8} rounded="lg" overflow={"hidden"} px={{ base: 10, lg: 10, }}>
            ...
            <HStack justifyContent={"space-between"} mt={10}>
                ...
                <Avatar name={data?.owner.name} size={"xl"} src={data?.owner.avatar}></Avatar>
